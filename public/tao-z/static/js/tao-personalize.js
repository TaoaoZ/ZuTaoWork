(function () {
  ...
  setHTML(".home-hero-title", 'Product Strategy<br><span class="txt-purple">UI Systems</span>');
  setText(".home-hero-sub", "8 \u5e74 B/G \u7aef\u4ea7\u54c1\u4e0e\u89e3\u51b3\u65b9\u6848\u7ecf\u9a8c\uff0c\u4ea4\u4e92\u51fa\u8eab\u3002\u805a\u7126\u9e3f\u8499\u751f\u6001\u3001AI \u57ce\u5e02\u6cbb\u7406\u4e0e\u590d\u6742\u4e1a\u52a1\u7cfb\u7edf\u4f53\u9a8c\u8bbe\u8ba1\u3002");
  setHTML(".home-hero-cap", 'HarmonyOS ecology<br><span class="txt-500">AI \u00d7 Urban Governance</span>');
  setText(".home-hero-label", "Based in Shenzhen / building useful systems");
  setText(".home-hero-thumb-mobile-txt", "Selected work");
  ...
  document.querySelectorAll("[data-video='to-play']").forEach((link) => {
    ...
    link.setAttribute("aria-label", "View selected work");
  });
  ...
  setText(".home-abt-title", "Tao.z turns complex business, devices and AI capabilities into clear product architecture, interaction flows and shippable UI systems.");
  setText(".home-abt-label", "Positioning");
  setText(".txt-btn", "Contact Tao");
  ...
  setText(".home-ser-title", "Capabilities");
  const capabilities = [
    ["Product Strategy", "\u4ea7\u54c1\u89c4\u5212\u3001\u9700\u6c42\u5b9a\u4e49\u3001\u7248\u672c\u8def\u7ebf\u4e0e\u653f\u4f01\u4ea4\u4ed8\u3002\u628a\u590d\u6742\u4e1a\u52a1\u62c6\u6210\u53ef\u843d\u5730\u7684\u7cfb\u7edf\u7ed3\u6784\u548c\u534f\u4f5c\u8def\u5f84\u3002"],
    ["HarmonyOS Solutions", "\u9e3f\u8499\u751f\u6001\u63a5\u5165\u3001\u591a\u7aef\u4f53\u9a8c\u3001ArkUI \u7ec4\u4ef6\u601d\u7ef4\u4e0e\u573a\u666f\u5316\u843d\u5730\uff0c\u8fde\u63a5\u8bbe\u5907\u3001\u4e1a\u52a1\u4e0e\u670d\u52a1\u751f\u6001\u3002"],
    ["AI \u00d7 Urban Governance", "DeepSeek / Qwen / \u667a\u80fd\u4f53\u573a\u666f\u5e94\u7528\uff0c\u5b9a\u4e49\u4e8b\u4ef6\u8bc6\u522b\u3001\u667a\u80fd\u6d3e\u5355\u4e0e\u95ed\u73af\u5904\u7f6e\u7684\u4eba\u673a\u534f\u540c\u94fe\u8def\u3002"],
    ["UI & Visual Systems", "\u4e2d\u540e\u53f0\u3001\u5927\u5c4f\u3001\u79fb\u52a8\u7aef\u4e0e\u89c6\u89c9\u8bbe\u8ba1\u7cfb\u7edf\uff0c\u6c89\u6dc0\u53ef\u590d\u7528\u7ec4\u4ef6\u89c4\u8303\uff0c\u964d\u4f4e\u8bbe\u8ba1\u5230\u5f00\u53d1\u7684\u8fd8\u539f\u504f\u5dee\u3002"]
  ];
  document.querySelectorAll(".home-ser-item").forEach((item, index) => {
    ...
    item.querySelectorAll(".home-ser-item-btn-txt").forEach((node) => { node.textContent = "Discuss"; });
    item.querySelectorAll(".home-ser-item-content-btn-txt").forEach((node) => { node.textContent = "Read focus"; });
  });

  setText(".home-proj-title", "Selected Work");
  setHTML(".home-proj-sub", "HarmonyOS ecology.<br>AI governance.<br>Product systems.<br>");
  const selectedWork = document.querySelector(".home-proj");
  if (selectedWork) selectedWork.id = "selected-work";
  const projects = [
    ["AI Governance", "\u5168\u57df\u6cbb\u7406\u4e00\u7f51\u7edf\u7ba1", "\u4ece\u8bbe\u5907\u611f\u77e5\u5230\u667a\u80fd\u6d3e\u5355\u7684\u57ce\u5e02\u6cbb\u7406\u95ed\u73af", "2025", ["tao-011.jpg", "tao-010.jpg"]],
    ["Smart City", "\u57ce\u5e02\u7a7a\u95f4\u6cbb\u7406\u670d\u52a1\u667a\u6167\u5e73\u53f0", "\u7f51\u683c\u3001\u4e8b\u4ef6\u3001\u90e8\u4ef6\u4e0e\u8bbe\u5907\u7684\u5168\u5468\u671f\u7ba1\u7406\u4e2d\u67a2", "2024", ["tao-010.jpg", "tao-011.jpg"]],
    ["Digital Transformation", "\u96c6\u56e2\u57ce\u5e02\u670d\u52a1\u6570\u5b57\u5316\u8f6c\u578b", "IOC\u3001\u4e1a\u52a1\u5e73\u53f0\u4e0e\u751f\u6d3b\u670d\u52a1\u7684\u7edf\u4e00\u4f53\u9a8c\u6846\u67b6", "2025", ["tao-008.jpg", "tao-007.jpg"]],
    ["FinTech", "GPTA \u73af\u7403\u79c1\u4eba\u4fe1\u6258\u8d26\u6237\u7cfb\u7edf", "\u9ad8\u51c0\u503c\u8d44\u4ea7\u4fe1\u606f\u7684\u6e05\u6670\u5316\u4ea7\u54c1\u8bbe\u8ba1", "2023", ["tao-004.jpg", "tao-004.jpg"]],
    ["Data Visualization", "\u9999\u6e2f\u5e73\u5b89\u949f\u5927\u6570\u636e\u53ef\u89c6\u5316\u7cfb\u7edf", "\u5eb7\u517b\u670d\u52a1\u573a\u666f\u4e2d\u7684\u5927\u5c4f\u5c55\u793a\u4e0e\u4e1a\u52a1\u95ed\u73af", "2023", ["tao-011.jpg", "tao-010.jpg"]]
  ];
  document.querySelectorAll(".home-proj-item").forEach((item, index) => {
    ...
    item.querySelectorAll(".home-proj-item-link").forEach((node) => {
      if (!node.classList.contains("w-condition-invisible")) node.textContent = "View case";
    });
